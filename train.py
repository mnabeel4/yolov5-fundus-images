...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='models/yolov5x.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/yolov5x.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='H:/workspace/Nabeel/yolov5/Diabetic-Retinopathy-Detection/data.yaml', help='data.yaml path')
