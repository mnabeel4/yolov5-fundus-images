...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='H:/workspace/Nabeel/yolov5/runs/exp80/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='H:/workspace/Nabeel/yolov5/Diabetic-Retinopathy-Detection/data.yaml', help='*.data path')
    parser.add_argument('--output', type=str, default='DR-Roboflow-detection-result3/output', help='output folder')
